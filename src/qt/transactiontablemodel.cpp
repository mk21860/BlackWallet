...
QString TransactionTableModel::formatTBLKTatus(const TransactionRecord *wtx) const
{
    QString status;
...
QVariant TransactionTableModel::tBLKTatusDecoration(const TransactionRecord *wtx) const
{
    if(wtx->type == TransactionRecord::Generated || wtx->type == TransactionRecord::StakeMint)
    {
        switch(wtx->status.maturity)
...
{
    QString tooltip = formatTBLKTatus(rec) + QString("\n") + formatTxType(rec);
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DecorationRole:
        ...
        {
        case Status:
            return tBLKTatusDecoration(rec);
        case ToAddress:
