    ...
    rpcConsole(0)
{
    ...
    labelEncryptionIcon->setStyleSheet("#labelEncryptionIcon QToolTip {color:#cecece;background-color:#CC0000;border:0px;}");
    labelConnectionsIcon->setStyleSheet("#labelConnectionsIcon QToolTip {color:#cecece;background-color:#CC0000;border:0px;}");
    labelBlocksIcon->setStyleSheet("#labelBlocksIcon QToolTip {color:#cecece;background-color:#CC0000;border:0px;}");
    labelMintingIcon->setStyleSheet("#labelMintingIcon QToolTip {color:#cecece;background-color:#CC0000;border:0px;}");
...
void BitcoinGUI::createActions()
{
	...
	chatPageAction = new QAction(QIcon(":/icons/chat"), tr("&Chat"), this);
    chatPageAction->setToolTip(tr("Chat with other BLKT peers"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    QString ss("QMenuBar {font-size: 14px; background-color: black; color: rgb(255,255,255); border: 1px solid #000; border-color: rgb(61,120,72);} QMenuBar::item { background-color: black; color: rgb(61,120,72);} QMenuBar::item::selected { background-color: rgb(61,120,72); color: black;} QMenu { background-color: black; color: rgb(61,120,72); border: 1px solid #000;} QMenu::item::selected { background-color: rgb(61,120,72);}");
    appMenuBar->setStyleSheet(ss);
    appMenuBar->setFixedHeight(30);
}
...
static QWidget* makeToolBarSpacer()
{
    ...
    spacer->setStyleSheet("QWidget { background: black; }");
    return spacer;
}
...
void BitcoinGUI::createToolBars()
{
    ...
    //can be added later with small blacktoken logo

    QWidget* header = new QWidget();
    header->setMinimumSize(120, 120);
    header->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
    header->setStyleSheet("QWidget { background-color: black; background-repeat: no-repeat; background-image: url(:/images/header); background-position: top center; }");
    ...
    toolbar->setStyleSheet("QToolButton {font-size:12px;min-height:40px;color:rgb(61,120,72);background-color:black;border:none;margin:0px;padding:0px;} QToolButton:hover { color: white; background-color: black; margin:0px; padding:0px; border-color:rgb(61,120,72);border-width:2px;border-style:inset; } QToolButton:checked { color: white; background-color: rgb(61,120,72); margin:0px; padding:0px; border-color:white;border-width:2px;border-style:inset;} QToolButton:pressed { color: #000000; background-color: rgb(61,120,72); margin:0px; padding:0px; border:none;} QToolButton:selected { color: #000000; background-color: rgb(61,120,72); margin:0px;padding:0px;border:none; } #tabsToolbar { min-height:40px; color: #000000; background-color: black; margin:0px; padding:0px; border-top-color: rgba(160, 160, 160, 191); border-top-width: 1px; border-top-style: inset; } QToolBar::handle { background-color: black; }");
}
