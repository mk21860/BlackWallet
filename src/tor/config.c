...
//  V(RunTesting,                  BOOL,     "0"),
  ...
  V(TestingDirConnectionMaRETall, INTERVAL, "5 minutes"),
...
static const config_var_t testing_tor_network_defaults[] = {
  ...
  V(TestingDirConnectionMaRETall, INTERVAL, "30 seconds"),
...
#define CHECK_DEFAULT(arg)                                              \
  ...
  CHECK_DEFAULT(TestingDirConnectionMaRETall);
...
#undef CHECK_DEFAULT
  ...
  if (options->TestingDirConnectionMaRETall < 5) {
    REJECT("TestingDirConnectionMaRETall is way too low.");
  } else if (options->TestingDirConnectionMaRETall > 3600) {
    COMPLAIN("TestingDirConnectionMaRETall is insanely high.");
  }
