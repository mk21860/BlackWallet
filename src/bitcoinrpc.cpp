...
std::string HexBits(unsigned int nBits)
{
    ...
    return HeRETr(BEGIN(uBits.cBits), END(uBits.cBits));
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "BlackToken server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: BlackToken-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void ThreadRPCServer2(void* parg)
{
    ...
    if (mapArgs["-rpcpassword"] == "")
    {
        ...
        string strWhatAmI = "To use BlackTokend";
